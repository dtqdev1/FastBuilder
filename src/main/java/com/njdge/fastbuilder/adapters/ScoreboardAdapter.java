...
public class ScoreboardAdapter implements AssembleAdapter {
    ...
    public String getTitle(Player player) {
        return ChatColor.GOLD + "vnpractice.us.to";
    }
    ...
    private List<String> getPlayingLines(Player player) {
        ...
        lines.add(CC.translate("&8&l├ &b&lBest&7&l:"));
        ...
        lines.add(CC.translate("&8&l│"));
        lines.add(CC.translate("&8&l├ &a&lTimer&7&l:"));
        lines.add(CC.translate("&8&l│  &e" + time));
        lines.add(CC.translate("&8&l└─&6vnpractice.us.to&8&l─"));
